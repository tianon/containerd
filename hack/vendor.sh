...
clone git github.com/gengo/grpc-gateway master
...
clone git github.com/matttproud/golang_protobuf_extensions master
...
clone git go.pedge.io/google-protobuf master https://github.com/peter-edge/go-google-protobuf.git
clone git go.pedge.io/proto master https://github.com/peter-edge/go-proto.git
clone git go.pedge.io/protolog master https://github.com/peter-edge/go-protolog.git
